...
public class LenderWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTblLoanCases(String category)
    {
         DefaultTableModel model = (DefaultTableModel) tblLoanCases.getModel();
          ...
          for(Loan loan : business.getLoanDirectory().getLoanList()){
              if(loan.getLoanStatus().equals(Loan.LoanStatus.FundingRequired) ||
                 loan.getLoanStatus().equals(Loan.LoanStatus.PartiallyFunded)){
       ...
       else
       {
           ...
           for(LendingInstance lendingInstance : basket.getLendingInstanceList()){
               if(loan.getLoanCase() == lendingInstance.getLoanCase()){
                   JOptionPane.showMessageDialog(null, "This loan case is already added to your Money Basket", "Information", JOptionPane.INFORMATION_MESSAGE);
                   return ;
               }
           }
    ...
    private void btnProceedActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
           ...
           BasketJPanel basketJPanel = new BasketJPanel(userProcessContainer, business, lender);
    ...
    private void btnAddCreditActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    ...
    private void initComponents() {
        ...
        jLabel3.setText("  CATEGORIES  ");
        jLabel3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 3, true));
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 144, -1, -1));

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("  BORROWER DETAILS  ");
        jLabel4.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 3, true));
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 192, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 808, 194));
        ...
        add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 470, 361, 48));
        ...
        add(btnView, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 470, 400, 48));
        ...
        add(btnProceed, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 560, 508, 61));

        creditComboBox.setForeground(new java.awt.Color(255, 255, 255));
        creditComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(creditComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 730, 182, -1));
        ...
        add(categoryComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(263, 150, 158, -1));

        jLabel10.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 4, true));
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(791, 13, -1, -1));

        jLabel6.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("  ADD CREDIT TO YOUR ACCOUNT  ");
        jLabel6.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 3, true));
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 660, -1, -1));
        ...
        add(btnAddCredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 720, 120, 36));

        lblname.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
        lblname.setForeground(new java.awt.Color(255, 255, 255));
        lblname.setText("NAME");
        add(lblname, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 40, -1, -1));

        lblcountry.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
        lblcountry.setForeground(new java.awt.Color(255, 255, 255));
        lblcountry.setText("COUNTRY");
        add(lblcountry, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 90, -1, -1));

        jLabel7.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("  CURRENT BALANCE AVAILABLE  ");
        jLabel7.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 3, true));
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 660, -1, -1));

        txtCurrentBalance.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true));
        add(txtCurrentBalance, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 720, 314, 34));
